...
//		queryString += "&cntntsId=%s";
		...
		queryString = String.format(
					queryString,
					RecallAPIConfig.SERVICE_ID, 1, 10);
		return queryString;
	...
	public List<RecallVO> getRecallList(String queryString) {
		...
		try {
			...
			strResult = restTemp.exchange(restURI, HttpMethod.GET, null, String.class);
			...
			result = restTemp.exchange(restURI, HttpMethod.GET, null, RecallRoot.class);
